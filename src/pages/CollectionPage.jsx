...
const CollectionPage = () => {
  ...
  return (
    <div className="overflow-auto px-5 sm:px-10 py-6">
      {collection.length > 0 ? (
        <div className="flex justify-between items-center mb-6">
          <h2 className="sm:text-xl font-semibold">Your Collection</h2>
          <button
            onClick={() => {
              clearFromCollection();
            }}
            className="bg-red-600 py-2 px-2  sm:px-5 rounded text-base font-medium active:scale-95 cursor-pointer"
          >
            Clear Collection
          </button>
        </div>
